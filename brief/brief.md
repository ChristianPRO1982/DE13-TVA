...
- Le rapport de réconciliation : valides, invalides, indéterminés, motifs de rejet, doublons 
- et la commande qui le produit. 
...
- Vérification VIES avec trois états, temporisation, journalisation et reprise. 
...
- Les trois états (valide, invalide, indéterminé) sont distingués et peuplés ; une indisponibilité du service n'est jamais enregistrée comme une invalidité. 
